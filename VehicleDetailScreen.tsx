...
export const VehicleDetailScreen: React.FC = () => {
  ...
  const [selectedTripRoute, setSelectedTripRoute] = useState<Array<{ coordinates: [number, number]; timestamp: Date }>>([]);
  const [alerts, setAlerts] = useState<any[]>([]);
  const [activeTab, setActiveTab] = useState<'overview' | 'history' | 'tracking' | 'maintenance'>('overview');
